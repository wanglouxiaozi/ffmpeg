...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=/root/qt5.5.1/another-webui/dependentlibsrc/ffmpeg-2.2.4/build/__install --enable-static --enable-shared --enable-pthreads --enable-cross-compile --cross-prefix=aarch64-linux-gnu- --cc=aarch64-linux-gnu-gcc --arch=arm --disable-asm --target-os=linux --optflags=-O0 --disable-programs
...
SRC_PATH=/root/qt5.5.1/another-webui/dependentlibsrc/ffmpeg-2.2.4
ifndef MAIN_MAKEFILE
SRC_PATH:=$(SRC_PATH:.%=..%)
endif
CC_IDENT=gcc 5.3.1 (Linaro GCC 5.3-2016.02) 20160113
ARCH=c
CC=aarch64-linux-gnu-gcc
CXX=aarch64-linux-gnu-g++
AS=aarch64-linux-gnu-gcc
LD=aarch64-linux-gnu-gcc
DEPCC=aarch64-linux-gnu-gcc
DEPCCFLAGS= $(CPPFLAGS)
DEPAS=aarch64-linux-gnu-gcc
DEPASFLAGS= $(CPPFLAGS)
YASM=yasm
DEPYASM=yasm
...
CFLAGS=   -std=c99 -fomit-frame-pointer -fPIC -pthread -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -O0 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wno-maybe-uninitialized
...
DEPWINDRES=aarch64-linux-gnu-gcc
